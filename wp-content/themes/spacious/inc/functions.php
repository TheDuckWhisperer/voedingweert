...
function spacious_footer_copyright() {
	...
	$wp_link = '<a href="'.esc_url( 'http://wordpress.org' ).'" target="_blank" title="' . esc_attr__( 'WordPress' ) . '"><span>' . __( 'WordPress' ) . '</span></a>';
	...
	$default_footer_value = sprintf( __( 'Copyright &copy; %1$s %2$s Chris Vossen' ), date( 'Y' ), $site_link )/*.' '.sprintf( __( 'Powered by %s.' ), $wp_link )*/;
        //.' '.sprintf( __( 'Theme: %1$s by %2$s.', 'spacious' ), 'Spacious', $tg_link );
